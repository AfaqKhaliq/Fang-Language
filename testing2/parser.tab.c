...
{
       0,   126,   126,   130,   140,   141,   145,   160,   161,   163,
     163,   164,   166,   167,   169,   176,   177,   178,   179
};
#endif
...
#line 145 "parser.y"
            ...
            GlobalTable.AddFunctionToTable((yyvsp[-3].strval),currentSignature,function_type);
        }
...
#line 169 "parser.y"
                           {
        currentSignature.param_types.push_back( (yyvsp[-1].type));

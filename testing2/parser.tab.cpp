...
#line 1 "parser.y"
    ...
    public:
        ...
        SymbolInfo() : size(0), value(""), type("void"), isFunc(false) {}
        ~SymbolInfo() {}
    ...
    public:
        ...
        void AddFunctionToTable(const string& id, FunctionSignature Sig, const string& return_type) {
            SymbolInfo func;
    ...
    string current_type;  // used for inherited attribute (type for IDLIST)
...
#line 122 "parser.y"
                                           {
        function_type = (yystack_[4].value.strval);
        has_return_statement = false;
...
#line 149 "parser.y"
                {
        currentSignature.param_types.push_back(string((yystack_[1].value.strval)));
        currentSignature.param_id.push_back(string((yystack_[0].value.strval)));
        sig_index++;
    }
...
#line 742 "parser.tab.cpp"
  ...
  parser::yyrline_[] =
  {
       0,   102,   102,   106,   117,   118,   122,   134,   135,   139,
     139,   140,   144,   145,   149,   157,   158,   159,   160
  };
